...
typedef enum OutputGroup {
  PD_PWR_DRIVER_CONTROLS = 0, // Enable driver controls
  PD_PWR_MAIN,                // Turn on everything needed to drive
  PD_PWR_AUX,
  PD_LIGHTS_LEFT,
  PD_LIGHTS_RIGHT,
  PD_LIGHTS_HZRD,
...
// Set a group of outputs with an operation
StatusCode output_set_group(OutputGroup group, OutputState state);
